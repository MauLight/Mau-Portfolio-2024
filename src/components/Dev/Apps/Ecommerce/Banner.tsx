  ...
  return (
    <div className="w-full min-h-[1000px] flex flex-col">
      <div className="relative w-full h-full flex justify-center items-center bg-[#fdfdfd]">
        ...
        <img src={product.image} alt="banner" className='absolute top-0 w-full h-full object-cover' />
        <div className="w-full absolute bottom-5 flex justify-end gap-x-10 px-5 z-10 transition-all duration-300">
          ...
          <div onClick={() => {}} className='h-[50px] w-[50px] antialiased rounded-full bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-70 flex justify-center items-center pb-1 cursor-pointer'>
