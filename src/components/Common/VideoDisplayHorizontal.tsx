...
export const VideoDisplayHorizontal = ({ video, bgColor } : VideoDisplayProps): ReactElement => {
  return (
    <div className="relative flex justify-center items-center w-full h-screen pt-[200px]">
      <div className="absolute w-screen flex flex-col justify-center items-start px-20 gap-y-5 bg-[#e7eee7] h-[450px] overflow-hidden">
        <motion.h1
          ...
          className='font-body text-6xl text-[#171817] z-10'>Shonen Extravaganza AMV</motion.h1>
        <motion.p
      ...
      <motion.video
        ...
        whileInView={'show'}
        viewport={{ once: false, amount: 0.1 }}
        src={video} autoPlay loop muted className='absolute w-1/2 h-1/2 right-0 top-[220px] object-cover z-10 rounded-[10px]' />
    </div>
  )
}
