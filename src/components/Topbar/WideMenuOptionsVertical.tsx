...
export const WideMenuOptionsVertical = ({ isUpperMenuOpen, setUpperMenuOpen } : WideMenuProps): ReactElement => {
  ...
  return (
    <motion.div
      ...
      className={`w-1/2 pb-10 ${pathname.includes('video') ? 'bg-[#10100e] border-b' : 'bg-[#ffffff]'} ${isUpperMenuOpen ? 'fixed' : 'hidden'} top-0 right-0 z-40 border-b`}
    >
      <div className="w-full h-full flex justify-center">
        ...
        <div className="h-full w-4/6">
          ...
          <div id='dev' className="col-span-1 flex flex-col pt-[70px] px-8 gap-y-2">
            <h1 className={`font-body text-[16px] ${pathname.includes('video') ? 'text-[#e7eee7]' : ''}`}>Dev</h1>
          ...
          <div id='photo' className="col-span-1 flex flex-col pt-[70px] px-8 gap-y-2">
            <h1 className={`font-body text-[16px] ${pathname.includes('video') ? 'text-[#e7eee7]' : ''}`}>Photo</h1>
            <div className="flex flex-col">
          ...
          <div id='video' className="col-span-1 flex flex-col pt-[70px] px-8 gap-y-2">
            <h1 className={`font-body text-[16px] ${pathname.includes('video') ? 'text-[#e7eee7]' : ''}`}>Video</h1>
            <div className="flex flex-col">
