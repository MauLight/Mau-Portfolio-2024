...
const animatedGradientText =
  "inline-block text-transparent bg-clip-text animated-background bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500";
...
export const WideMenu = ({
  ...
  return (
    <div className="hidden col-span-3 sm:flex justify-between items-center">
      ...
      <a href="https://ctlst.cc" className={`${animatedGradientText} text-lg`}>
        CTLST
      </a>
      <FlipLink
        onClick={() => {}}
