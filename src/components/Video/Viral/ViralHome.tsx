...
import AMVweb2 from '@/assets/video/Dragon_AMV WEB.webm'
...
import motivation4 from '@/assets/video/Motivation 4.webm'
...
const ViralHome = (): ReactElement => {
  return (
    <div className='w-full min-h-screen flex flex-col justify-center items-center gap-y-44 bg-[#10100e]'>
      ...
      <VideoDisplayVertical frame='750px' title="Show, Don't Tell" description='New campaign' mp4={[]} webM={[motivation1, motivation2, motivation3, motivation4]} bgColor='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500' />
    </div>
  )
}
