    ...
    >
      <div className="w-[1440px] h-[100px] grid grid-cols-3">
        ...
        <div className="relative flex">
          <div className="absolute -bottom-[65px] flex justify-start items-end w-full h-[100px] z-50"></div>
        </div>
        <div className="flex items-center justify-end"></div>
      </div>
      <div className="w-[1440px] grid grid-cols-3">
        <div className="flex justify-start items-end pb-5">
          <p className="font-body text-[18px] text-[#fdeeff]">
        ...
        <div className="flex flex-col items-end gap-y-2 pb-5">
          <div className="flex h-[100px] border items-start">
            <QRCode
              className="w-[100px] h-[100px] border border-gray-200 opacity-80"
              value="https://drive.google.com/file/d/1X17JPFMm0A09eonmj0AqkqHmkHsiMU98/preview"
            />
          </div>
          <p className="font-body text-[18px] text-[#10100e]">© 2026 MLight</p>
        </div>
      </div>
    </motion.div>
  );
